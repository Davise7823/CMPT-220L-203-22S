{
        ...
        "ArrayList<String> rainbow2 = new ArrayList<String>();\n",
        "// rainbow2.add(rainbow);\n",
        "rainbow2.add(\"Pink\");\n",
        "rainbow2.add(\"Red\");\n",
        "\n",
        ...
        "- And a lot more. \n",
        "\n",
        "For the rest of the semester we'll be trying to adhere to some of the things that Google Style Guide requires of programmers. \n",
